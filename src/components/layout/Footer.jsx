    ...
    <footer className={styles.footer}>
      ...
      <div className={`container ${styles.main}`}>
        ...
        <div className={styles.col}>
          <div className={styles.brand}>
            <span className={styles.brandName}>Biswajit</span>
            <span className={styles.brandSub}>Civil Engineer</span>
          </div>
          <p className={styles.tagline}>
            Building safe, lasting structures for homes and businesses across North Bengal.
          </p>
          <div className={styles.contactList}>
            {[
              { icon: '📍', label: 'Address', val: siteConfig.location, href: null },
              { icon: '📞', label: 'Phone', val: siteConfig.phone, href: `tel:${siteConfig.phone.replace(/\s|-/g, '')}` },
      ...
      <div className={styles.bottom}>
        <div className={`container ${styles.bottomInner}`}>
          ...
          <p className={styles.bottomRight}>Built with Next.js + Three.js + Framer Motion</p>
        </div>
      </div>
    </footer>
  );
